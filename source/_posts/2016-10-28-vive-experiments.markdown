...
Some recent games have a similar 'skiing' mechanic where the player walks around by grabbing the air and pulling, alternating each hand. It's not as much fun as flying in zero-gravity though.

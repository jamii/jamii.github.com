...
* Built a relational query compiler that [outperforms Postgres](http://scattered-thoughts.net/blog/2016/10/11/a-practical-relational-query-compiler-in-500-lines/) on the Join Order Benchmark. Compiles queries into zero-allocation, [worst-case optimal](https://arxiv.org/abs/1310.3314) native code.

...
* Built a live-coding interpreter and editor plugin for a relational language, capable of executing code as it is typed whilst still being resilient to bugs, typos and infinite loops.

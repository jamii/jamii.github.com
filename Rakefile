...
task :generate do
  ...
  system "compass compile --css-dir #{source_dir}/_includes"
  system "jekyll"
end
...
task :watch do
  ...
  system "compass compile --css-dir #{source_dir}/_includes" unless File.exist?("#{source_dir}/_includes/screen.css")
...
task :clean do
  rm_rf [".pygments-cache/**", ".gist-cache/**", ".sass-cache/**", "source/_includes/screen.css"]
end
...
task :set_root_dir, :dir do |t, args|
  ...
  if args.dir
    ...
    compass_config.sub!(/css_dir(\s*)=(\s*)(["'])[\w\-\/]*["']/, "css_dir\\1=\\2\\3public#{dir}/_includes\\3")
